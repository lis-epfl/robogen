{
	...
	var xDiff = (curPos.x - lightSourcePos.x);
	var yDiff = (curPos.y - lightSourcePos.y);
	var zDiff = (curPos.z - lightSourcePos.z);
	this.trialFits[this.getCurTrial()] += Math.sqrt(Math.pow(xDiff,2) + Math.pow(yDiff,2) + Math.pow(zDiff,2));
	this.timeSteps++;
	return true;
    },
